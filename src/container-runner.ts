...
import { CONTAINER_IMAGE, DATA_DIR, GROUPS_DIR, IDLE_TIMEOUT, ONECLI_URL, TIMEZONE, VAULT_PATH } from './config.js';
...
function buildMounts(
  ...
  // Obsidian vault — primary memory source, mounted read-write for all groups
